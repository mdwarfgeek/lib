...
SRCS=airmass.c bary.c cholesky.c cnf.c cvtunit.c dtai.c dtdb.c dsincos.c fpcoord.c geoc.c iers.c jpleph.c linsolve.c matvec.c mjd.c mount.c mpc.c observer.c parallactic.c prenut.c refract.c rng.c shuffle.c skylevel.c sort.c source.c strutil.c stumpff.c sysinfo.c util.c wcs.c
OBJS=${SRCS:%.c=%.o}
